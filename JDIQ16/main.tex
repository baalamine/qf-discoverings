...
Apart limitations of actual truth discovery systems such as constraining assumptions, complex model settings, and scalability issues, we 
present in the next other actionable research challenges that together aim at effectively address the truth discovery problem in real-world 
over-information scenarios. We also highlight our vision of a solution.
