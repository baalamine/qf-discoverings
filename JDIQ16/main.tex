...
The Open World Assumption often holds in truth discovery contexts
because observation data may be incomplete and biased for various 
...
%may have been observed and reported by the sources.
Modeling the data provider's/observer's is crucial since online sources have  various levels of 
{\it a priori} knowledge about the observation data 
...
%It is thus important to explore how one can retrieve and quantify
%the observation effort from modeling the data provider's/observers' distribution. Data  can be biased
%in many other ways. 
%For example, data can be affected by a {\it selection bias} that is the extent to
...
%to  include certain events or details). 
