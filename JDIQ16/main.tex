...
of each claim as a function of the trustworthiness its sources~\cite{YinHY08}, several probabilistic models carefully 
incorporating other domain specific aspects such as source dependence~\cite{DongBHS10a}, temporal dimension in evolving 
truth~\cite{DongBS09a}, hardness of certain claims~\cite{GallandAMS10},  or complex data structures~\cite{ZhaoRGH12,GoasdoueKKLMZ13}.
