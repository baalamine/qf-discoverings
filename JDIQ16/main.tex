...
%With an exponential growth of online user-generated content,
...
Given a set of assertions from multiple sources, the ultimate goal of truth discovery is to predict the truth label of each claimed
data item and compute sources' reliability with no \emph{a priori} knowledge about the truthfulness of the assertions and the sources. One 
...
from various limitations, e.g., strong assumptions about claims and sources, that restrict
%restrictive assumptions, opacity, complex model settings, and lack of scalability, 
their usability to the wide diversity of Web information and realistic scenarios where knowing the truth as soon as possible 
is critical. 
...
%We also briefly highlight our vision of a preliminary solution.
