...
Discovering truth over past events and historical data is certainty useful as one has access to 
a ground truth and full data sets for estimating the precision of the results.
...
to the communities that will consume them.
