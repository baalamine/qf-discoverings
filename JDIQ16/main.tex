...
model. We believe that such a solution has 
\begin{inparaenum}[(i)]
\item to provide a concrete and unified semantics to truth discovery systems, e.g., in modal logics using axioms and canonical 
\emph{Kriphe} structures~\cite{GorankoOtto06};
