...
data items as true or false and compute sources' reliability with no \emph{a-priori} knowledge of the 
truthfulness of the input arguments. One major line of previous work relaxed such a assumption and extended 
fact-finding models with prior knowledge either about the claimed assertions~\cite{PasternackR13} or about the source 
...
models have been proposed to incorporate various aspects beyond source trustworthiness and claim belief, namely: the 
dependence between sources \cite{DongBHS10a}, the temporal dimension in discovering evolving truth  \cite{DongBS09a}, 
the difficulty of ascertaining the veracity of certain claims \cite{GallandAMS10}, the management of complex  data structures
such as collections of entities in a claim \cite{ZhaoRGH12} or linked data \cite{GoasdoueKKLMZ13}.
