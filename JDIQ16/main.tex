...
%gained unprecedented attention since they play an essential role in classifying and verifying  manually (or semi-automatically) online information.
...
intelligence and the database communities, sometimes investigated under the names of  \textquote{fact-checking}~\cite{GoasdoueKKLMZ13}, ``information trustworthiness''~\cite{Thirunarayan2014182}, ``information credibility''~\cite{PasternackR13} or ``information corroboration''~\cite{GallandAMS10}. 
