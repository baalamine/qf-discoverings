...
\textquote{semantic markers} which explain {\it when, where, how, why,} and
{\it for which purpose/audience} it has been produced.
%, what it is supposed 
%to mean in the absolute sense and
...
Wikipedia have to be \emph{aligned} with considering the source granularity ({\it i.e.}, a source can be an
