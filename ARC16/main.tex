...
.
 ...
 and the characteristics of the dataset, e.g. the distribution of conflicts, the similarity of data item values, ect. Therefore,
 this raises the question of a thorough understanding of the state-of-the-art truth discovery algorithms. 
 ...
 We propose a study to deal with open truth discovery challenges which consists of the following initial results.
 
 
 \begin{itemize}
  \item A thorough comparative study of twelve truth discovery algorithms
  \item A design and release of the first REST API for truth discovery algorithms
