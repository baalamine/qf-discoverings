...
\begin{enumerate}
 ...
 our base learning algorithm and the labeled claims $\claimset^{\mathsf{L}}$ \lamine{How the base learning algorithm should be implemented?}
 ...
 $m$ true claims  \lamine{How the selection strategy should be defined?}
