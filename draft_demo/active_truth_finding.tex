...
Several query strategies, e.g., uncertainty sampling or query by committee, have been proposed for the definition of such a optimal sample of data. Note that 
