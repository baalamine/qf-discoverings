...
\begin{enumerate}
 ...
 our base learning algorithm and the labeled claims $\claimset^{\mathsf{L}}$ \lamine{How the base learning algorithm is supposed to work?}
 ...
 $m$ true claims  \lamine{The selection is randomly or not?}
