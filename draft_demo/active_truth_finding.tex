...
set which is used for adapting the configuration of the ensemble, a  and a stopping criteria (e.g., a predefined number of iterations). At each iteration,
the algorithm chooses exactly one
