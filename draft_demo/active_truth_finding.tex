...
In our context, the truth finding algorithms represent our classifiers. The underlying \emph{binary classification} 
...
%we are interesting on discovering the optimal combinaison among several possible truth finding algorithms
...
to certain application domains or datasets. As a consequence, there is no approach that outperforms the others on all 
