...
\section{Open Information Extraction}\label{openie}
\begin{itemize}
...
% OIE Input and Ouput
\paragraph*{Information extraction} We aim at analyzing 
...
Assume a user query $\query$ about a real-word fact $\fact{\query}$ and the set of $n$ answers $v_1^{\query}\ldots v_n^{\query}$
...
\lamine{Types de requ\^etes \'a supporter?}

\lamine{Traitement de requ\^etes en batch ou traitement une par une?}
