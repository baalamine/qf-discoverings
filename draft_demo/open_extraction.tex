...
over numerous sources. Multiple contradictory Web claims of such a type about a given real-life fact 
...
specifies a possible relationship between the two given entities $\e{1}$ and $\e{2}$. None of the three 
