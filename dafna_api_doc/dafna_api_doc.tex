...
sources. The DAFNA API for truth discovery is a RestFul one that enables end user applications to access and use twelve existing truth discovery algorithms
...
For instance, to respectively create and list the datasets, one must use the following
URLs with some input parameters, as we will see further. 
\begin{description}
