...
\begin{itemize}
 \item \textbf{user\_token}: secret token provided to the client for authentication 
 \item  \textbf{checked\_algo}: set of algorithm name(s) followed by respective arrays of parameters, e.g. \textquote{checked\_algo}: \{\textquote{Accu}: [\textquote{0.2}, \textquote{0}, \textquote{100}, \textquote{0.5}, \textquote{false}, \textquote{true}, \textquote{true}, \textquote{false}] , \textquote{cosine}: [\textquote{1}, \textquote{0.2}] \}
...
\begin{itemize}
 \item \textbf{user\_token}: secret token provided to the client for authentication
 \item \textbf{id}: an existing identier of the runset whose results must be listed
\end{itemize}
\textbf{Response}
\begin{description}
 \item
