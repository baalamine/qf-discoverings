...
\hline \\
\textbf{SimpleLCA}&\begin{tabular}{@{}l@{}}Prior Truth Probability $pt\in[0,1]$\\\end{tabular}\\
\hline \\
\textbf{GuessLCA}&\begin{tabular}{@{}l@{}}Prior Truth Probability $pt\in[0,1]$\\\end{tabular}\\
\hline \\
\textbf{MLE(multi-valued property values)}&\begin{tabular}{@{}l@{}}Prior Truth Probability $pt\in[0,1]$\\\end{tabular}\\
\hline \\
\textbf{LTM(multi-valued property values)}&\begin{tabular}{@{}l@{}}Prior Truth Probability $pt\in[0,1]$\\Prior Falsehood Probability $pf\in[0,1]$\\prior True Negative Count $p_1\in[0,1]$\\Prior False Positive Count $p_2\in[0,1]$\\Prior False Negative Count $p_3\in[0,1]$\\Prior True Positive Count $p_4\in[0,1]$\\Number of Iterations $iter\in \mathbb{N}^{\ast}$\\Burn-in $b\in \mathbb{N}^{\ast}$\\Thinning $t\in \mathbb{N}^{\ast}$\\\end{tabular}\\
\bottomrule
\end{tabular}
